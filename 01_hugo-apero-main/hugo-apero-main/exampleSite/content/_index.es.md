...
method_quote: |
  «La verdadera base del “rigor” reside en la aplicación adecuada de las técnicas. Cuando se aplican de manera deficiente o engañosa, tanto las técnicas cuantitativas como las cualitativas producen conclusiones deficientes o engañosas».
method_question: |
  ¿Cómo sería si ambas, aplicadas con el máximo rigor disciplinario, se pusieran, con humanidad y humildad, al servicio de corregirse mutuamente?
method_quote_source: |
  Frase de White (2001), citada en Kanbur, *Social Science and Development* (2001).
cv: documents/orlando-valladares-cv-es.pdf
email: oavalladares@uvg.edu.gt
images:
  - img/orlando-valladares.jpg
image_left: true
